...
char a = 10; // divas darbības
             // mainīgā deklarēšana - char a - vietas piešķiršana atmiņai
...
printf("a mainīgā vērtība (kā hexidecimāls skaitlis): %#x\n",a);
printf("a mainīgā vērtība (kā oktāls skaitlis): %#o\n",a);

//char a; //nedrīkst pārdeklerēt mainīgo
...
printf("b mainīgā vērtība pirms vērtības piešķiršanas (kā hexidecimāls skaitlis): %#x\n",b);
printf("b mainīgā vērtība pirms vērtības piešķiršanas (kā oktāls skaitlis): %#o\n",b);

b = 250;
// 250 vietā redzams -6 kāpēc?                                                   7654 3210
...
printf("b mainīgā vērtība pēc vērtības piešķiršanas (kā hexidecimāls skaitlis): %#x\n",b);
printf("b mainīgā vērtība pēc vērtības piešķiršanas (kā oktāls skaitlis): %#o\n",b);

unsigned char c = 320;
printf("\nc mainīgā vērtība pēc vērtības piešķiršanas (kā simbols): %c\n",c);
printf("c mainīgā vērtība pēc vērtības piešķiršanas (kā decimāls skaitlis): %d\n",c);
printf("c mainīgā vērtība pēc vērtības piešķiršanas (kā hexidecimāls skaitlis): %#x\n",c);
printf("c mainīgā vērtība pēc vērtības piešķiršanas (kā oktāls skaitlis): %#o\n",c);
